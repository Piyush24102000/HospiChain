...
export default function Hospital_navbar() {
    return (
        <div>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <Link href="./"><a class="navbar-brand">HospiChain</a></Link>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active">
                                <Link href="./"><a class="nav-link">Hospital Registration</a></Link>
                            </li>
                            <li class="nav-item active">
                                <Link href="./Doctor"><a class="nav-link">Doctor Registration </a></Link>
                            </li>
                            <li class="nav-item active">
                                <Link href="./Patient"><a class="nav-link">Patient Registration </a></Link>
                            </li>
                            <li class="nav-item active">
